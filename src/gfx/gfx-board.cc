...
unsigned int Board::getCaseFromCoordinates(float x, float y) const
{
	...
	{
		unsigned int a = cases_[case_idx].first;
...
LimitedEditionBoard::LimitedEditionBoard()
	: Board()
{
	sprite_ = SpriteLibrary::instance()->sprite("board");
	...
	cases_.push_back(make_pair(COL_8, ROW_5));
	cases_.push_back(make_pair(COL_8, ROW_6));
	cases_.push_back(make_pair(COL_9, ROW_6));
	cases_.push_back(make_pair(COL_10, ROW_6));
	cases_.push_back(make_pair(COL_11, ROW_6));
	cases_.push_back(make_pair(COL_11, ROW_7));
	cases_.push_back(make_pair(COL_8, ROW_8));
	cases_.push_back(make_pair(COL_7, ROW_8));
	cases_.push_back(make_pair(COL_6, ROW_8));
	cases_.push_back(make_pair(COL_5, ROW_8));
	cases_.push_back(make_pair(COL_4, ROW_8));
	cases_.push_back(make_pair(COL_3, ROW_8));
	cases_.push_back(make_pair(COL_2, ROW_8));
	cases_.push_back(make_pair(COL_1, ROW_8));
	cases_.push_back(make_pair(COL_1, ROW_7));
	cases_.push_back(make_pair(COL_1, ROW_6));
	cases_.push_back(make_pair(COL_1, ROW_5));
	cases_.push_back(make_pair(COL_1, ROW_4));
	cases_.push_back(make_pair(COL_1, ROW_3));
	cases_.push_back(make_pair(COL_1, ROW_2));
	cases_.push_back(make_pair(COL_1, ROW_1));
	cases_.push_back(make_pair(COL_2, ROW_1));
	cases_.push_back(make_pair(COL_3, ROW_1));
	cases_.push_back(make_pair(COL_4, ROW_1));
	cases_.push_back(make_pair(COL_5, ROW_1));
	cases_.push_back(make_pair(COL_6, ROW_1));
	cases_.push_back(make_pair(COL_7, ROW_1));
	cases_.push_back(make_pair(COL_8, ROW_1));
	cases_.push_back(make_pair(COL_9, ROW_1));
	cases_.push_back(make_pair(COL_10, ROW_1));
	cases_.push_back(make_pair(COL_11, ROW_1));
	cases_.push_back(make_pair(COL_11, ROW_2));
	cases_.push_back(make_pair(COL_11, ROW_3));
	cases_.push_back(make_pair(COL_10, ROW_3));
}
